...
#define POWERUP_DELAY_BETWEEN_LED_BLINK		50			// time in ms


// *************************************************************************************************************************************
long static timeON_100US[8][10] = {
		{2000,		 50,		 50,		 50,		 50,		 50,		 50,		 50,		 50,		 10},
		...
		{5000,		 50,		 50,		 50,		 50,		 50,		 50,		 50,		 50,		 1000}
};
...
long static timeOFF_100US[8][10] = {
		...
		{5000,		 50,		 50,		 50,		 50,		 50,		 50,		 50,		 50,		 9000}
};
